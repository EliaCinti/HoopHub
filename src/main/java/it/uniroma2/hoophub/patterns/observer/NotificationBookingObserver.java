 ...
 * Refactored to use Domain Models (Model-First approach).
 *
 * @author Elia Cinti
 */
public class NotificationBookingObserver implements DaoObserver {
    ...
    private void createVenueManagerNotification(Booking booking) throws DAOException {
        ...
        // Retrieve VenueManager username via VenueDao
        ...
        // FIX: Create Notification Model (not Bean)
