...
public class UserDaoCsv extends AbstractCsvDao implements UserDao {
    ...
    public synchronized UserType validateUser(Credentials credentials) throws DAOException {
        ...
        // FIX: Controllo robusto array vuoto
    ...
    public synchronized void saveUser(User user) throws DAOException {
        ...
        // CACHE: Aggiungiamo l'oggetto salvato alla cache (Usa user.getClass() a runtime es. Fan o VenueManager)
    ...
    public synchronized String[] retrieveUser(String username) throws DAOException {
        ...
        // Ritorna raw data per i DAO figli. findRowByValue gestisce già il ritorno di array vuoto se non trovato.
    ...
    public synchronized void deleteUser(User user) throws DAOException {
        ...
        // REFACTORING: Usa il metodo helper del padre invece di riscrivere la logica
        ...
        // CACHE: Rimuoviamo l'oggetto dalla cache usando il tipo reale (Fan/VenueManager)
